...
.btn-add { background: #28a745; border: none; color: white; }
.btn-add:hover { background: #218838; }
.btn-update { background: #ffc107; border: none; color: white; }
...
<div class="management-box">
    ...
    <a href="view_students.php" class="btn btn-view">View Student Dashboard</a>
    <a href="add_student.php" class="btn btn-add">Add Student</a>
    <a href="update_student.php" class="btn btn-update">Update Student Details</a>
    <a href="delete_student.php" class="btn btn-delete">Delete Student</a>
